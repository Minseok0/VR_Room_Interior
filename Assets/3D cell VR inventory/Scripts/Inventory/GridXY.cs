...
namespace Inventory
{
    ...
    public class GridXY
    {
        ...
        public void PlaceItem(Transform _item, InventoryCellObject cell, AxisDirections ?llOrientationAxis = default)
        {
            ...
            itemdata.item.transform.localRotation = Quaternion.Euler(ItemData.CalculateDirection(llOrientationAxis));
